    ...
    <section className="py-10 bg-gradient-to-br from-orange-50 via-white to-orange-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-lg md:text-2xl text-gray-600 max-w-2xl mx-auto mb-2">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
        <div className="bg-white/90 rounded-3xl shadow-2xl border border-orange-200 overflow-hidden flex flex-col md:flex-row h-auto md:h-[600px]">
          ...
          {/* Left column */}
          <div className="flex flex-col px-4 py-8 bg-gradient-to-b from-orange-50 to-white border-r border-orange-100 md:w-[320px] w-full">
            {/* Intro */}
            <div>
          ...
          <div className="flex flex-col items-center justify-center bg-transparent flex-1 p-3">
            <div className="relative w-full flex items-center justify-center md:h-[350px] h-[210px]">
              <FinalMap
                style={{ width: '100%', height: '100%', maxWidth: 450, maxHeight: 450 }}
                onMouseLeave={() => setHoveredState(null)}
              >
                {/* Example: interactive state highlighting can be added as needed */}
              </FinalMap>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between items-center px-4 py-8 bg-gradient-to-b from-white to-orange-50 border-t md:border-t-0 md:border-l border-orange-100 md:w-[320px] w-full">
            ...
            <div className="mt-6 w-full max-w-xs">
              <div className="bg-orange-100 text-orange-700 rounded-lg px-4 py-2 text-xs shadow">
                <b>Tip:</b> Click “Browse Statewise Page” to see all numbers for every state and union territory in one place!
              </div>
            </div>
          </div>
        </div>
